...
// 				UserID: 1, User: model.User{ID: 1, Name: "saad", Email: "saad@user.com"},
// 				DestinationID: 1, Wallet: model.Wallet{ID: 1, UserID: 1, User: model.User{ID: 1, Name: "saad", Email: "saad@user.com"}, Number: "100001", Balance: 10000},
...
// 		input.User = &model.User{ID: 1, Name: "saad", Email: "saad@user.com"}
